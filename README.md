...
These commands were designed and refined by running them on their own source — the enhancements in this repo were generated by a 3-round `/brainstorm`, implemented by a `/build` developer team, and validated by a `/review-fix` loop.
